...
<required_reading>
@D:/VSC/xbrain/.claude/get-shit-done/references/ai-frameworks.md
@D:/VSC/xbrain/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/VSC/xbrain/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/VSC/xbrain/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/VSC/xbrain/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/VSC/xbrain/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/VSC/xbrain/.claude/agents/gsd-eval-planner.md for instructions.
