...
```markdown
Read D:/VSC/xbrain/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/VSC/xbrain/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/VSC/xbrain/.claude/agents/gsd-ui-checker.md for instructions.
