...
```bash
INIT=$(node "D:/VSC/xbrain/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/VSC/xbrain/.claude/get-shit-done/templates/spec.md.
