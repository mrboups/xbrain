...
```
Task(
  prompt="Read D:/VSC/xbrain/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/VSC/xbrain/.claude/get-shit-done/templates/SECURITY.md`
