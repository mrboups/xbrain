...
<reference>
@D:/VSC/xbrain/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/VSC/xbrain/.claude/get-shit-done/references/user-profiling.md` to load:
