...
<required_reading>
@D:/VSC/xbrain/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/VSC/xbrain/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/VSC/xbrain/.claude
                  → checks D:/VSC/xbrain/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/VSC/xbrain/.claude/get-shit-done
                  → writes to D:/VSC/xbrain/.claude/get-shit-done/hooks/
...
@D:/VSC/xbrain/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/VSC/xbrain/.claude/get-shit-done/references/common-bug-patterns.md
